...
abstract class FriendshipDao {
    ...
    abstract fun getRequestsToMe(user_uuid: String): List<User>
    ...
    abstract fun getMyRequests(user_uuid: String): List<User>
    ...
    abstract fun cacheFriendships(stories: List<Friendship>)
